...
public class Producto {
    ...
    // --- NUEVOS ATRIBUTOS PARA LA TIENDA DE ROPA ---
    @NotBlank(message = "La talla es obligatoria")
    private String talla; // Ej: S, M, L, XL, 30, 32

    @NotBlank(message = "El color es obligatorio")
    private String color; // Ej: Rojo, Azul, Negro

    private String material; // Ej: Algodón, Jean, Lino

    private String género; // Ej: Hombre, Mujer, Unisex, Infantil
    // ----------------------------------------------
