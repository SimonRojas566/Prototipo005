...
public class ProductoController {
    ...
    // --- NUEVOS CAMPOS VISUALES PARA LA TIENDA DE ROPA ---
    @FXML TextField txtTalla, txtColor, txtMaterial, txtGenero;
    // ----------------------------------------------------
    ...
    public void initialize(){
        ...
        columns.put("Tipo Producto", new ColumnInfo("tipoProducto", 120.0));
        columns.put("Nombre", new ColumnInfo("nombre", 180.0));
        columns.put("Talla", new ColumnInfo("talla", 80.0));     // <-- Añadido a la tabla
        columns.put("Color", new ColumnInfo("color", 100.0));    // <-- Añadido a la tabla
    ...
    public void validarFormulario() {
        ...
        // --- CAPTURANDO LOS DATOS DE ROPA ---
        formulario.setTalla(txtTalla.getText());
        formulario.setColor(txtColor.getText());
        formulario.setMaterial(txtMaterial.getText());
        formulario.setGénero(txtGenero.getText());
        // ------------------------------------
    ...
    private void mostrarErroresValidacion(List<ConstraintViolation<Producto>> violaciones) {
        ...
        campos.put("talla", txtTalla);       // <-- Mapeo de errores
        campos.put("color", txtColor);       // <-- Mapeo de errores
    ...
    public void editForm(Producto producto) {
        ...
        // --- CARGAR DATOS DE ROPA AL EDITAR ---
        txtTalla.setText(producto.getTalla() != null ? producto.getTalla() : "");
        txtColor.setText(producto.getColor() != null ? producto.getColor() : "");
        txtMaterial.setText(producto.getMaterial() != null ? producto.getMaterial() : "");
        txtGenero.setText(producto.getGénero() != null ? producto.getGénero() : "");
        // --------------------------------------
    ...
    public void limpiarError() {
        List.of(txtNombreProducto, txtTalla, txtColor, txtMaterial, txtGenero,
                        cbxTipoProducto, txtPUnit, txtPUnitOld, txtUtilidad,
